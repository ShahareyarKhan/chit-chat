...
const Register = () => {
    ...
    return (
        <div className='w-full mx-auto bg-white p-3 min-h-[100vh] flex flex-col justify-center px-9'>
            ...
            <div className='flex gap-3 items-center justify-center p-3 mt-5 cursor-pointer rounded hover:rounded-xl border border-gray-300' onClick={async () => {
                await googleSignIn();
                navigate('/');
            }}>
                <div>
