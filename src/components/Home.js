    ...
    <>
      {loading ? (
        <div className="flex items-center justify-center h-screen">
          ...
          {/* You can replace the text with a spinner component if you prefer */}
        </div>
      ) : (
        <>
          <div className='home min-h-[100vh] flex flex-col md:hidden'>
          ...
          <div className='hidden md:flex'>
            ...
            <div className='flex-1 bg-[#3d6da1] min-w-[57%]'>
              {!friendSelect && !groupSelect && (
                <div className='flex flex-col justify-center items-center h-screen text-white text-xl font-semibold'>
