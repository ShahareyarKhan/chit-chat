...
//         <div className="flex flex-col h-screen w-full chatsection bg-[#295789]">
//             <div className="w-full sticky top-0 bg-[#164c7b] p-3 flex items-center z-50 text-white">
//                 <div className="cursor-pointer" onClick={() => setFriendSelect(null)}>
//                     <IoMdArrowRoundBack className="text-xl md:text-2xl" />
//                 </div>
//                 <div className="ml-4 flex items-center gap-3 w-full">
//                     {friend.pic ? (
//                         <img src={friend.pic} alt={friend.name} className="relative w-[40px] h-[40px] rounded-full" />
//                     ) : (
//                         <div className='relative text-xl w-[40px] h-[40px] rounded-full flex items-center justify-center font-bold bg-white text-black border border-black'>
//                             {friend.name[0]}
//                         </div>
...
//                 </div>
//                 <div>
//                     <FaPhone onClick={() => setCall(true)} />
//                 </div>
//             </div>
//             <div className='w-full flex justify-center'>
//                 <div className='fixed bottom-[70px] p-1 bg-[#000000] text-white hover:shadow-xl z-50 rounded-full cursor-pointer' onClick={scrollToBottomHandler}>
//                     <BiSolidArrowToBottom className='text-xl' />
//                 </div>
//             </div>
//             <div className="flex-1 px-4 p-2 overflow-auto" onScroll={(e) => {
//                 setScrollToBottom(e.target.scrollHeight - e.target.scrollTop === e.target.clientHeight);
//             }}>
//                 {renderMessagesWithDates()}
//                 <div ref={messagesEndRef} />
//                 {typingMessage && (
...
//                         }}
//                     />
//                     <button onClick={handleSendMessage} className="text-white p-2">
//                         <IoSend className="text-2xl text-[#075E54]" />
//                     </button>
//                 </div>
//             </div>
